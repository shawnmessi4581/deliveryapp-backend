...
// // NOTE: We removed the class-level @PreAuthorize so we can control each
// method
// // individually
...
// @PreAuthorize("hasRole('ADMIN')") // ONLY Admins can create other
// Admins/Employees
// public ResponseEntity<UserResponse> createDashboardUser(@RequestBody
...
// @PostMapping(value = "/drivers", consumes =
// MediaType.MULTIPART_FORM_DATA_VALUE)
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')") // Both can register new
// drivers
...
// // --- SUBCATEGORIES ---
// @PostMapping(value = "/subcategories", consumes =
// MediaType.MULTIPART_FORM_DATA_VALUE)
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
...
// @PutMapping(value = "/subcategories/{id}", consumes =
// MediaType.MULTIPART_FORM_DATA_VALUE)
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
...
// @PostMapping(value = "/stores", consumes =
// MediaType.MULTIPART_FORM_DATA_VALUE)
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
...
// @PutMapping(value = "/stores/{id}", consumes =
// MediaType.MULTIPART_FORM_DATA_VALUE)
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
...
// Page<Product> productPage = adminService.getAllProducts(storeId, categoryId,
...
// @RequestParam(value = "image", required = false) MultipartFile image,
// @RequestParam(value = "gallery", required = false) List<MultipartFile>
// gallery) {
...
// // 1. Save it to DB
// ProductVariant variant = adminService.addProductVariant(productId, name,
// priceAdjustment);
...
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
// public ResponseEntity<String> deleteProductVariant(@PathVariable Long
// variantId) {
...
// @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
// public ResponseEntity<DeliveryInstruction> createInstruction(@RequestParam
// String text) {
...
// Color updatedColor = adminService.updateColor(id, request.getName(),
// request.getHexCode());
