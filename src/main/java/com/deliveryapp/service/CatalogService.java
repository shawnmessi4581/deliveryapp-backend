...
// return
// subCategoryRepository.findByCategoryCategoryIdAndIsActiveTrueOrderByDisplayOrderAsc(categoryId);
// }
...
// return
// storeRepository.findByCategoryCategoryIdAndIsActiveTrueOrderByDisplayOrderAsc(categoryId);
// }

// public List<Store> getStoresBySubCategory(Long subCategoryId) {
// if (!subCategoryRepository.existsById(subCategoryId)) {
// throw new ResourceNotFoundException("الفئة الفرعية غير موجودة برقم: " +
// subCategoryId);
// }
// // ✅ FIX: Only Active Stores, Ordered
// return
// storeRepository.findBySubCategorySubcategoryIdAndIsActiveTrueOrderByDisplayOrderAsc(subCategoryId);
// }
...
// public Page<Product> getProductsByCategory(Long categoryId, Pageable
// pageable) {
// if (!categoryRepository.existsById(categoryId)) {
// throw new ResourceNotFoundException("الفئة غير موجودة برقم: " + categoryId);
// }
// return
// productRepository.findByCategoryCategoryIdAndIsAvailableTrue(categoryId,
// pageable);
// }

// public Page<Product> getProductsBySubCategory(Long subCategoryId, Pageable
// pageable) {
// if (!subCategoryRepository.existsById(subCategoryId)) {
// throw new ResourceNotFoundException("الفئة الفرعية غير موجودة برقم: " +
// subCategoryId);
// }
// return
// productRepository.findBySubCategorySubcategoryIdAndIsAvailableTrue(subCategoryId,
// pageable);
// }

// public Page<Product> searchProducts(String keyword, Long categoryId, Pageable
// pageable) {
// if (keyword == null)
// keyword = "";
// if (categoryId == null || categoryId == 0) {
// return
// productRepository.findByNameContainingIgnoreCaseAndIsAvailableTrue(keyword,
// pageable);
// } else {
// return
// productRepository.findByCategoryCategoryIdAndNameContainingIgnoreCaseAndIsAvailableTrue(categoryId,
// keyword, pageable);
// }
// }

// public Page<Product> searchProductsInStore(String keyword, Long storeId,
// Pageable pageable) {
// if (!storeRepository.existsById(storeId)) {
// throw new ResourceNotFoundException("المتجر غير موجود برقم: " + storeId);
// }
...
// keyword = "";
// return
// productRepository.findByStoreStoreIdAndNameContainingIgnoreCaseAndIsAvailableTrue(storeId,
// keyword,
// pageable);
// }

// public Page<Product> getProductsByStoreAndCategory(Long storeId, Long
// categoryId, Pageable pageable) {
// return
// productRepository.findByStoreStoreIdAndCategoryCategoryIdAndIsAvailableTrue(storeId,
// categoryId,
// pageable);
// }

// public Page<Product> getProductsByStoreAndSubCategory(Long storeId, Long
// subCategoryId, Pageable pageable) {
// return
// productRepository.findByStoreStoreIdAndSubCategorySubcategoryIdAndIsAvailableTrue(storeId,
// subCategoryId,
// pageable);
// }
...
// return
// productRepository.findByBasePriceLessThanEqualAndIsAvailableTrue(price,
// pageable);
// }
